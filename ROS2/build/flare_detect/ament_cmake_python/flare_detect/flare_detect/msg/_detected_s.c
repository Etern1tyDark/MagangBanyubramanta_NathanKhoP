...
bool flare_detect__msg__detected__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flare_detect.msg._detected.Detected", full_classname_dest, 35) == 0);
  }
  flare_detect__msg__Detected * ros_message = _ros_message;
  {  // red
...
PyObject * flare_detect__msg__detected__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("flare_detect.msg._detected");
