...
class Metaclass_Detected(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('obj_msg')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'obj_msg.msg.Detected')
            logger.debug(
    ...
    def RED(self):
        ...
        return Metaclass_Detected.__constants['RED']

    @property
    def YELLOW(self):
        """Message constant 'YELLOW'."""
        return Metaclass_Detected.__constants['YELLOW']

    @property
    def BLUE(self):
        """Message constant 'BLUE'."""
        return Metaclass_Detected.__constants['BLUE']
