...
static const _Motion_type_support_symbol_names_t _Motion_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pub_controller, msg, Motion)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pub_controller, msg, Motion)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pub_controller, msg, Motion)() {
  return &::pub_controller::msg::rosidl_typesupport_c::Motion_message_type_support_handle;
}
