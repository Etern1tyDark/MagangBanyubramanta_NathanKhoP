...
#include "pub_controller/msg/detail/motion__rosidl_typesupport_fastrtps_c.h"
...
#include "pub_controller/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Motion__ros_msg_type = pub_controller__msg__Motion;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pub_controller
size_t get_serialized_size_pub_controller__msg__Motion(
  const void * untyped_ros_message,
...
static uint32_t _Motion__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pub_controller__msg__Motion(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pub_controller
size_t max_serialized_size_pub_controller__msg__Motion(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pub_controller__msg__Motion;
    is_plain =
      (
...
static size_t _Motion__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pub_controller__msg__Motion(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pub_controller, msg, Motion)() {
