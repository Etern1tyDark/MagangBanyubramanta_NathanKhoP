...
bool pub_controller__msg__motion__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pub_controller.msg._motion.Motion", full_classname_dest, 33) == 0);
  }
  pub_controller__msg__Motion * ros_message = _ros_message;
  {  // x_cmd
...
PyObject * pub_controller__msg__motion__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pub_controller.msg._motion");
