...
#include "custom_msg_pub/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msg_pub::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msg_pub::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msg_pub::msg::Num *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_custom_msg_pub
const rosidl_message_type_support_t *
get_message_type_support_handle<custom_msg_pub::msg::Num>()
{
  return &custom_msg_pub::msg::typesupport_fastrtps_cpp::_Num__handle;
}
