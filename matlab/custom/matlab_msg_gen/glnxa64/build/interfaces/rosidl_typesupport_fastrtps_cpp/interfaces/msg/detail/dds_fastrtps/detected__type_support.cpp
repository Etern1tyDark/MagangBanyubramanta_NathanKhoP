...
#include "interfaces/msg/detail/detected__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Detected & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Detected & ros_message)
{
  // Member: color
  cdr >> ros_message.color;
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Detected *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Detected *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Detected__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Detected)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Detected__handle;
}
