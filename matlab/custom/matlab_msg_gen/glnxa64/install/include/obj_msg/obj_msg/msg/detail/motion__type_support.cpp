...
{
  new (message_memory) obj_msg::msg::Motion(_init);
}

void Motion_fini_function(void * message_memory)
{
  auto typed_message = static_cast<obj_msg::msg::Motion *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Motion_message_member_array[4] = {
  {
    ...
    offsetof(obj_msg::msg::Motion, x_cmd),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(obj_msg::msg::Motion, y_cmd),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(obj_msg::msg::Motion, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(obj_msg::msg::Motion, depth),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::obj_msg::msg::rosidl_typesupport_introspection_cpp::Motion_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, obj_msg, msg, Motion)() {
  return &::obj_msg::msg::rosidl_typesupport_introspection_cpp::Motion_message_type_support_handle;
}
