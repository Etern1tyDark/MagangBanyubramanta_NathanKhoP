...
set(_exported_libraries "obj_msg__rosidl_generator_c;obj_msg__rosidl_typesupport_c;obj_msg__rosidl_typesupport_cpp;obj_msg_matlab")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'obj_msg' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND obj_msg_LIBRARIES ${_cfg} "${_lib}")
